...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM db_mahasiswa WHERE id = '$id'");
    ...
    // Query tambah data
    $query = "INSERT INTO db_mahasiswa (id, nama_kegiatan, waktu_kegiatan) VALUES ('$id', '$nama_kegiatan', '$waktu_kegiatan')";
